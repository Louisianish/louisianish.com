...
function displayWeather() {
  ...
  if (text == "clear sky" && weather.iconId == "01d")
    document.getElementById("kourivini").innerHTML = text.replace(
      text,
      "plin soléy"
    );
  ...
  if (locationElement.innerHTML == "Chicago, US")
    document.getElementById("location").innerHTML = cityKv.replace(
      cityKv,
      "Shikago, Ozilinwa"
    );
